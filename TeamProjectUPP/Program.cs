...
public class Program
{
    ...
    {
        // Создание объекта типа Magazine и вывод данных с помощью ToShortString()
        Magazine magazine = new Magazine("Ежемесячный технический журнал", Frequency.Monthly, DateTime.Now, 5000);
        Console.WriteLine(magazine.ToShortString());

        // Вывод значений индексатора для значений индекса Frequency
        ...
        // Добавление статей и вывод данных объекта Magazine с помощью ToString()
